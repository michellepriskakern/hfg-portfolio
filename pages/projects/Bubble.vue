...
</section> <!-- ✅ Nur hier korrekt schließen! -->

    <!-- KONZEPT SECTION (Vertikal unter dem großen Text) -->
    <section class="container mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 gap-10">
      <div></div> <!-- Leerer Platzhalter für linke Spalte -->
      <div>
        <h2 class="text-3xl font-bold mb-4">Concept</h2>
        <p class="text-lg leading-relaxed">
          Our project shows how digital technologies can be used specifically to support people with borderline personality disorder.          <br><br>
          By combining reflection, biometric data and AI-supported support, we want to help those affected to better understand their emotions and deal with critical moments.          <br><br>
          It was particularly important to us to develop an application that can be seamlessly integrated into everyday life and supports both the therapeutic process and personal well-being.        </p>
      </div>
    </section>
